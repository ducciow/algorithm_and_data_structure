 ...
 * @Author: duccio
 * @Date: 25, 03, 2022
 * @Description: Quick sort: ver1, partition for <=, > pivot, which is chosen to be the rightmost item
 *                           ver2, partition for <, ==, > pivot, which is chosen to be the rightmost item
 *               Also, recursion version and iteration version
 * @Note:   1. Partition ver2 needs an extra swap at the end, unlike ver1
 *          2. The iteration version uses a stack, and needs to ensure the stack goes to empty by checking
 *          before pushing
 */
